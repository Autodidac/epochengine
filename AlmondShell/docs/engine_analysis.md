...
- Raylib now renders GUI sprites in framebuffer space instead of reapplying HiDPI scaling, stopping atlas buttons from shrinking
  as docked windows resize on high-density monitors.
