...
// 🌍 **Individual Project Information**
		...
		inline std::string PROJECT_VERSION = "0.57.12"; // Change to match the current version, match the version in aversion.hpp, changing this will trigger an update above this version from the repo
