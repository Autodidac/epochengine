...
namespace almondnamespace::plugin {
    ...
    public:
        ...
        explicit PluginManager(const std::string& logFileName, almondnamespace::RobustTime& timeSystem)
            : logger(almondnamespace::Logger::GetInstance(logFileName, timeSystem)), timeSystem(timeSystem) {
        }
    ...
    private:
        ...
        almondnamespace::Logger& logger;            // Shared Logger instance
        almondnamespace::RobustTime& timeSystem;    // Reference to RobustTime
    };
