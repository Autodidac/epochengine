...
//{
//#if defined(_WIN32)
//    void ClampMouseToClientRectIfNeeded(const std::shared_ptr<context::Context>& ctx, int& x, int& y) noexcept
//    {
...
//        }
//
//        auto process_context = [&](const std::shared_ptr<context::Context>& ctx) {
//            if (!ctx) {
//                return false;
//            }
//
