...
namespace almondnamespace {
    ...
    class SaveSystem {
    public:
        static void SaveGame(const std::string& filename, const std::vector<almondnamespace::Event>& events) {
        ...
        static void LoadGame(const std::string& filename, std::vector<almondnamespace::Event>& events) {
