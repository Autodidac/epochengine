...
namespace almondnamespace {
    ...
    private:
        ...
        std::vector<almondnamespace::Entity> entities; // Store the entities
        ComponentManager componentManager; // Manage components

        almondnamespace::Entity& getEntity(int entityId) {
    ...
    public:
        ...
        int createEntity() {
            almondnamespace::Entity entity(nextEntity, 0.0f, 0.0f, "entity.log", almondnamespace::RobustTime::getCurrentSteadyTime()); // Pass parameters to Entity constructor
        ...
        void addComponent(int entityId, T component) {
            try {
                almondnamespace::Entity& entity = getEntity(entityId);
